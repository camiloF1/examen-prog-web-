...
SECRET_KEY = 'q4v*ds&(x&&esy03_d5_ha6ncqn2n9nq(-od1c(^+$zv73qtqc'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'personas.context_processor.total_carrito',
            ],
        },
    },
]
...
LOGOUT_REDIRECT_URL = reverse_lazy('indexNormal')
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'instituto/static'),
)
